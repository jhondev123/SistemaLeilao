...
namespace SistemaLeilao.Core.Domain.Common
{
    public class Result
    {
        ...
        public SuccessMessage? Message { get; }
        public IEnumerable<ErrorMessage>? Errors { get; }
        public IEnumerable<string>? ErrorsWithoutCode { get; }

        protected Result(bool isSuccess, SuccessMessage? message, IEnumerable<ErrorMessage>? errors)
        {
            IsSuccess = isSuccess;
            Message = message;
            Errors = errors;
        ...
        public static Result Success(SuccessMessage message) => new(true, message, null);
    ...
    public class Result<T> : Result
    {
        ...
        private Result(bool isSuccess, T? data, SuccessMessage? message, IEnumerable<ErrorMessage>? errors)
            : base(isSuccess, message, errors)
        {
            Data = data;
        }

        public static Result<T> Success(T data, SuccessMessage message) => new(true, data, message, null);
